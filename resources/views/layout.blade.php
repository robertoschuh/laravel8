	...
	<div id="header" class="container">
		...
		<div id="menu">
			<ul>
				...
				<li class="{{ Request::is('post*') ? 'current_page_item' : ''}}"><a href="/posts/my-first-post" accesskey="2" title="">Our Clients</a></li>
				<li class="{{ Request::is('about')  ? 'current_page_item' : ''}}"><a href="/about" accesskey="3" title="">About Us</a></li>
				<li class="{{ Request::path() === 'work' ? 'current_page_item' : ''}}"><a href="/work" accesskey="4" title="">Careers</a></li>
